...
<h1 style="color:white;text-align:center;">Disease Mortality Prediction APP</h1>
<h5 style="color:white;text-align:center;">Hepatitis B </h5>
<h4 style="color:black;text-align:center;">Created by:  <u>Ashish Joshi, Aniruddh Joshi, Diksha Bargali<u> </h4>
</div>
"""
...
<h3 style="text-align:justify;color:black;padding:10px">What is Hepatitis B?</h3>
<p style="color:black;">Hepatitis B is an infection of your liver. It’s caused by a virus. There is a vaccine that protects against it. For some people, hepatitis B is mild and lasts a short time. These “acute” cases don’t always need treatment. But it can become chronic. If that happens, it can cause scarring of the organ, liver failure, and cancer, and it even can be life-threatening.It’s spread when people come in contact with the blood, open sores, or body fluids of someone who has the hepatitis B virus.
It's serious, but if you get the disease as an adult, it should not last a long time. Your body fights it off within a few months, and you’re immune for the rest of your life. That means you can't get it again. But if you get it at birth, it’ unlikely to go away.
</p></div>
        ...
        if st.sidebar.checkbox('Login'):
            ...
            if result:
                ...
                if activity == 'Plot':
                    ...
                    st.markdown("<h2 style='text-align: center; color: darkblue;'>Data Viz Plot</h2>",
